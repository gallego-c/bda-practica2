...
def run_integrated_enriched_pipeline(df, reports_dir: Path, models_dir: Path, save_json, save_model):
    numeric_features = [
        "age_years_proxy",
        "bmi",
        "systolic_bp",
    ...
    report = {
        "pipeline": "model_pipeline_integrated_enriched",
    ...
    save_json(reports_dir / "integrated_enriched_report.json", report)
    save_model(models_dir / "integrated_enriched_model.pkl", best_model)
    return report
